...
NEURON { :public interface of the mechanism
    ...
    RANGE Tx, phi
    : Tx fraction of light intensity reaching the segment per area (1/cm2), phi: photons/(time*channelrhodopsin) phi (photons/(ms*channel)= Tx (1/cm2) * source_flux (photons/ms) * sigma_retinal (cm2/channel), where sigma_retinal is the crossection of channelrhodopsin
